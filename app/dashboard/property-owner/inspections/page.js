...
export default async function Page() {
    ...
    const summaryCards = [
        ...
        { label: "Scheduled", value: 0, color: "bg-[#73A0BE]", icon: <span className="text-white text-lg font-bold">0</span> },
        { label: "Completed", value: 0, color: "bg-[#C7D9E5]", icon: <span className="text-white text-lg font-bold">0</span> },
        { label: "Pending", value: 0, color: "bg-[#FBC0BC]", icon: <span className="text-white text-lg font-bold">0</span> },
    ];
    ...
    return (
        <div className="space-y-6 p-6">
            ...
            <DashboardGridItem title="Property Inspections">
                <EmptyState message="Inspections management is coming soon. You will be able to schedule, track, and report on property inspections." />
            </DashboardGridItem>
        </div>
    );
}
