...
import { invitePropertyManager } from "../_lib/action";
import { FaAngleLeft, FaAngleRight, FaEnvelopeOpenText } from "react-icons/fa6";

const inviteSteps = [
    { step: 1, label: "Manager Info" },
    { step: 2, label: "Invitation" },
    { step: 3, label: "Review & Send" },
];

const defaultMessage = "You have been invited to join Xpacy as a property manager. Please sign up to start managing properties.";
...
const InviteManagerForm = () => {
    ...
    const onSubmit = async (data) => {
        ...
        toast.promise(invitePropertyManager(formData), {
    ...
    return (
        <div className="flex flex-col gap-12 w-[796px] mx-auto pb-12">
            ...
            <header className="flex flex-col items-center justify-center gap-4">
                <h2 className="text-3xl font-bold text-primary">Invite Property Manager</h2>
                <p className="font-mono">Send an invitation email to onboard a new property manager.</p>
            </header>
            {/* Progress bar */}
            ...
            <form className="p-6 flex flex-col gap-8" onSubmit={handleSubmit(onSubmit)}>
                ...
                {activeStep === 1 && (
                    <>
                        <h3 className="text-lg">Manager Information</h3>
                    ...
                    <>
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex gap-4 items-center p-4 rounded-lg border border-primary-100 bg-primary-100/40 font-mono text-sm text-gray-700">
                                ...
                                <p>An invitation email will be sent to <span className="font-bold text-primary">{watched.email || "the manager's email"}</span> with a link to join Xpacy as a property manager.</p>
                            </div>
